...
public class UbahPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack = (ImageButton) findViewById(R.id.btn_back_ubah_password_orang_tua);
        ...
        if (extras != null) {
            ...
            Toast.makeText(UbahPasswordActivity.this, "dari Login:"+kodeNIs, Toast.LENGTH_SHORT).show();
        ...
        btnUbah.setOnClickListener(new  View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ubahPass(kodeNIs,passBaru.getText().toString());
            }
        });
    }
        ...
        call.enqueue((new Callback<ResponseUbahPass>() {
            ...
            public void onResponse(Call<ResponseUbahPass> call, Response<ResponseUbahPass> response) {
                if(response.code() == 200){
                    Toast.makeText(UbahPasswordActivity.this, "Berhasil Dirubah", Toast.LENGTH_SHORT).show();
                }
            }
